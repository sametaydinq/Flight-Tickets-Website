...
if ( $_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $sql = " SELECT * FROM ucus_listesi WHERE Flight_Code=$Flight_Code";
    ...
    do {
        ...
        $sql = "UPDATE ucus_listesi " . "SET Fromm='$Fromm' , Too='$Too' ,
        Flight_Date = '$Flight_Date', Flight_Time='$Flight_Time, Price='$Price" . 
...
<head>
  ...
  <body>
    <div class="container my-5">
        ...
        ?>
        <form method="post">
            <input type="hidden" name="Flight_Code" value="<?php echo $Flight_Code; ?>">
            <div class="row mb-3">
